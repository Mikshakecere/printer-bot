...
class Client(commands.Bot):
    async def on_ready(self):
        ...
        try:
            guild = discord.Object(id=530935500270338058)
...
GUILD_ID = discord.Object(id=530935500270338058)

@client.tree.command(name="fetch_races", description="Fetch all races for the given ct", guild=GUILD_ID)
...
@client.tree.command(name="fetch_relics", description="Fetch all race relevant relics for the given ct", guild=GUILD_ID)
...
@client.tree.command(name="fetch_all_info", description="Fetch all info for the given ct", guild=GUILD_ID)
async def fetch_relics(interaction: discord.Interaction, ct_number: int):
